...
public class BlockBodyJsonSerializer extends JsonSerializer<Object>
    implements ContextualSerializer {
  private final RlpConverterService rlpConverterService;

  public BlockBodyJsonSerializer(final RlpConverterService rlpConverterService) {
  ...
  public void serialize(
      ...
      throws IOException {
    gen.writeString(rlpConverterService.buildRlpFromBody((BlockBody) value).toHexString());
  }

  @Override
  public JsonSerializer<?> createContextual(
      final SerializerProvider prov, final BeanProperty property) {
    return new BlockBodyJsonSerializer(rlpConverterService);
  }
}
