 ...
 */
package net.consensys.fleet.common.event;
...
public class BesuEventSubscription {
  ...
  private final Function<BlockAddedObserver, Long> subscriber;
  ...
  private BesuEventSubscription(
      ...
      final Function<BlockAddedObserver, Long> subscriber,
   ...
   */
  public Function<BlockAddedObserver, Long> getSubscriber() {
    return subscriber;
  }
