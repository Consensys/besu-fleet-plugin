 ...
 */
package net.consensys.fleet.leader.peer;

import net.consensys.fleet.common.peer.PeerNetworkMaintainer;
import net.consensys.fleet.common.peer.PeerNodesManager;

public class LeaderPeerNetworkMaintainer extends PeerNetworkMaintainer {

  private final PeerNodesManager peerNodesManager;

  public LeaderPeerNetworkMaintainer(final PeerNodesManager peerNodesManager) {
  ...
  @Override
  public void start() {
    peerNodesManager.createCache(true);
  }
}
