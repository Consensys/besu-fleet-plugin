...
public class FleetGetBlockByNumberServer extends AbstractFleetGetBlockServer
    implements PluginRpcMethod {

  public FleetGetBlockByNumberServer(
  ...
  protected Optional<GetBlockResponse> getBlock(
    ...
    final GetBlockByNumberRequest getBlockRequest =
        OBJECT_MAPPER.readValue(
            rpcRequest.getParams()[0].toString(), GetBlockByNumberRequest.class);
