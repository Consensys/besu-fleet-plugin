...
https://github.com/ConsenSys/fleet/blob/master/CODE-OF-CONDUCT.md
...
* Software version: [`fleet --version` or look for log lines starting with `Fleet State manager version:`]
